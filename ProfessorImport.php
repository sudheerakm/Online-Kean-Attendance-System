...
<div id="content">
  <div class="main-content-agile">
    <br><br> 
    <p style="text-align: center;font-weight: bold;font-size: 30px;">Professor CSV import</p>
        ...
        if($_FILES['csv_data']['name']){
          ...
          if($arrFileName[1] == 'csv'){
            ...
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
              ...
              $Email_id = mysqli_real_escape_string($conn,$data[6]);
              $Phone_number = mysqli_real_escape_string($conn,$data[4]);
              $Password = mysqli_real_escape_string($conn,$data[5]);


              $import="INSERT into Professor(First_name,Last_name,Department,Email_id,Phone_number,Password) values('$First_name','$Last_name','$Department','$Email_id',$Phone_number,'$Password');";
