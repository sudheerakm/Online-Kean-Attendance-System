...
<div id="content">
  ...
  <div class="main-content-agile">
    ...
    <div class="sub-main-w3">
      ...
      <form method='POST' enctype='multipart/form-data' action="Student_Attendance.php">
        Select Course:<br>
        <?php
        ...
        $Sid=$sid_row['Sid'];
        $course_results = mysqli_query($conn,"SELECT Course_id FROM student_course where Sid='$Sid'");
        ...
        $sid_row= mysqli_fetch_assoc($results);
        $Sid=$sid_row['Sid'];
        $semester_results = mysqli_query($conn,"SELECT distinct(Semester) FROM student_course where Sid='$Sid'");
        echo "<select name='Semester'>";
        while( $semester_row = mysqli_fetch_array($semester_results) ){
                   
          ?>

          <option 
          value='<?php echo($semester_row['Semester'])?>' >
          <?php echo($semester_row['Semester'] )?> </option>
          <?php
        }
        echo "</select>";
        ?>
