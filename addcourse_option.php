...
<body>
    ...
    <a href="add_course.php" class="btn" style="display: flex; justify-content: center;">Manually Add Course</a>
    <a href="CourseImport.php" class="btn" style="display: flex; justify-content: center;">Course CSV import</a>
