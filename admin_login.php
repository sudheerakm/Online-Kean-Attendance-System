	...
	<div id="content">
		...
		<div class="main-content-agile">
			<div class="sub-main-w3">
				...
				<div id="result"></div>
				<form id="loginForm" name="loginForm" action="admin_login_check.php" method="post">
					...
					<div class="pom-agile">
						...
						<input placeholder="Username" name="username" id="user_name" class="user" type="text" required="" value="<?php if(isset($_COOKIE["member_login"])) { echo $_COOKIE["member_login"]; } ?>" >
					</div>

					<label style="color: black">Password</label>
					<div class="pom-agile">
						<span class="fa fa-key" aria-hidden="true" ></span>
						<input placeholder="Password" name="password" id="password" class="pass" type="password" required="" value="<?php if(isset($_COOKIE["member_password"])) { echo $_COOKIE["member_password"]; } ?>">
					</div>
