...
<body>
    ...
    <a href="add_professor.php" class="btn" style="display: flex; justify-content: center;">Manually Add Professor</a>
    <a href="ProfessorImport.php" class="btn" style="display: flex; justify-content: center;">Professor CSV import</a>
