...
<body>
    ...
    <a href="addProfessor_Option.php" class="btn" style="display: flex; justify-content: center;">Add Professor</a>
    <a href="addstudent_option.php" class="btn" style="display: flex; justify-content: center;">Add Student</a>
    <a href="addcourse_option.php" class="btn" style="display: flex; justify-content: center;">Add Course</a>
