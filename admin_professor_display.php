        ...
        <div class="zerogrid" style="text-align: center;">
            <div class="col-full">
                ...
                <ul class="sf-menu">
                    ...
                    <!-- <li><a href="admin_login.ph">pADMIN LOGIN</a></li> -->
...
if ( isset($_SESSION['success']) && $_SESSION['success'] == 1)
{
     ...
     echo "Professor account updated";
...
$query2 = " SELECT * FROM Professor";
	...
	echo "<form name='input' action='admin_professor_update.php' method='post' autocomplete='off' >
	<TABLE border=1>
	<tr><td bgcolor=yellow>First name<td bgcolor=yellow>Last name<td bgcolor=yellow>Email_ID<td bgcolor=yellow>Department<td bgcolor=yellow>Phone number<td bgcolor=yellow>Password";
...
<tr><!-- <td><?php echo "$Pid";?> --><td><input type='text' name='firstname[]' size=30 value=<?php echo "$firstname"; ?>><td><input type='text' name='lastname[]' size=30 value= <?php echo "$lastname"; ?>><td><input type='email' name='email[]' size=30 value= <?php echo "$email"; ?>><td><input type='text' name='department[]' size=30 value=<?php echo "$department"; ?>><td><input type='number' name='phone[]' size=30 value=<?php echo "$phone"; ?>><td><input type='text' name='password[]' size=30 value=<?php echo "$password";?>></td></tr>
