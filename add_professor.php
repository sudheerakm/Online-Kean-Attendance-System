...
elseif(isset($_SESSION['success']) && $_SESSION['success'] == 2){
 ...
 ?>
  ...
  <form name="form1" id="ff" method="post" onsubmit= " return validateForm();" action="professor_insert_sucess.php">
        ...
        <br>
        <!-- Professor ID<br>
        <input type="text" name="professor_id" value="" required="required">
        <br> -->
        Department<br>
        ...
        <br>
        Password<br>
        <input type="password" autocomplete="off"  maxlength="128" name= "password" id = "password" required="required">
        <br>
        Retype Password<br>
       <input type="password" autocomplete="off"  maxlength="128" name="password2" id = "password2" required="required">
        <br><br>
