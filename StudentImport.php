...
<div id="content">
  ...
  <div class="main-content-agile">
    <br><br> 
    <p style="text-align: center;font-weight: bold;font-size: 30px;">Student CSV import</p>
        ...
        if($_FILES['csv_data']['name']){
          ...
          if($arrFileName[1] == 'csv'){
            ...
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
              ...
              $Email_id = mysqli_real_escape_string($conn,$data[4]);         
              $Password = mysqli_real_escape_string($conn,$data[5]);             


              $import="INSERT into students(Student_id,First_name,Last_name,Department,Email_id,Password) values('$Student_id','$First_name','$Last_name','$Department','$Email_id','$Password');";
            ...
            echo "Please attach a file in CSV format";
          }
        }
